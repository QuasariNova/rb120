...
class BankAccount
  ...
  # Settter methods only return what was passed to them. Therefore, #balance=
  # will never return false unless false was passed to it. Therefore, it will
  # always return a truthy value when used as intended. I instead removed it
  # and simplified the #withdraw method to one if statement.
...
# It will return the mutated object that was passed as an argument.
